...
public final class HelloServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.grpc.HelloRequest,
      com.grpc.HelloResponse> METHOD_SEND_HELLO =
      io.grpc.MethodDescriptor.<com.grpc.HelloRequest, com.grpc.HelloResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "HelloService", "sendHello"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.grpc.HelloRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.grpc.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendHello(com.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.grpc.HelloResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_SEND_HELLO, responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.grpc.HelloRequest,
                com.grpc.HelloResponse>(
  ...
  public static final class HelloServiceStub extends io.grpc.stub.AbstractStub<HelloServiceStub> {
    ...
    public void sendHello(com.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.grpc.HelloResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_SEND_HELLO, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.grpc.HelloResponse sendHello(com.grpc.HelloRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_SEND_HELLO, getCallOptions(), request);
    }
  }
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpc.HelloResponse> sendHello(
        com.grpc.HelloRequest request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_SEND_HELLO, getCallOptions()), request);
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_HELLO:
          serviceImpl.sendHello((com.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.grpc.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpc.HelloWorldProto.getDescriptor();
    }
